			...
			<div id="main" class="container">
				...
				<!-- One -->
					<section id="one" class="feature major">
						...
						<h2>We are nerd college and we can help you take over the world.</h2>
						<p>Our goal is to provide a place where we can all get our nerd on so here it is. This
						is a place where you can ask questions and have them answered by other nerds who are learning the same thing. All you have to do is create an account and log in. </p>
					</section>
					...
					<section id="two" class="feature">
						<div class="row">
							<div class="4u 12u$(medium)">
								<h2>Discussions</h2>
								<p>We love web technologies and linux so thats what we focus on
								but if you have other questions, feel free to start new discussions.</p>
								<ul class="actions">
									<li><a href="#" class="button">Start new discussion</a></li>
								</ul>
							</div>
